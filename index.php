...
<body>
    ...
    <div id="app" class="antialiased text-gray-700 bg-gray-100">
            ...
            <div class="flex flex-col items-center justify-between px-10 py-10 mb-8 -mt-20 space-y-5 bg-white sm:flex-row xl:w-full md:space-y-0">
                <div class="akreditasi lg:w-1/2">
                    <div class="flex flex-col items-center md:flex-row">
                        <img src="/wp-content/themes/smkplusalfarhan/resources/svg/akreditasi.svg" class="" alt="akreditasi">
        ...
        <section class="pt-12 pb-24 bg-gray-100">
        ...
        <section class="pt-24 pb-12 bg-white">
            <div class="max-w-5xl px-6 mx-auto ">
                ...
                <a href="https://dapo.kemdikbud.go.id/sekolah/AF9586728BD8DA4DBCD8#rekapitulasi" target="_blank" class="block mt-12 ml-8 text-sm text-green-600-smkplusa md:ml-0">Lihat lebih lengkap</a>
